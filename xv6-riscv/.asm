...
void f3(void *arg)
{
   ...
   c:	1800                	addi	s0,sp,48
    ...
    while (1) {
        printf("thread 3: %d\n", i++);
   e:	6489                	lui	s1,0x2
  10:	71048593          	addi	a1,s1,1808 # 2710 <__global_pointer$+0x1307>
  14:	00001517          	auipc	a0,0x1
  18:	b9c50513          	addi	a0,a0,-1124 # bb0 <thread_start_threading+0x3a>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b8898993          	addi	s3,s3,-1144 # bb0 <thread_start_threading+0x3a>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  32:	71590913          	addi	s2,s2,1813 # 2715 <__global_pointer$+0x130c>
            return;
            //thread_exit();
        }
        thread_yield();
...
void f2(void *arg)
{
  ...
  74:	b5050513          	addi	a0,a0,-1200 # bc0 <thread_start_threading+0x4a>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b3ea0a13          	addi	s4,s4,-1218 # bc0 <thread_start_threading+0x4a>
        if (i == 10) {
  8a:	49a9                	li	s3,10
...
void f1(void *arg)
{
 ...
 102:	ad250513          	addi	a0,a0,-1326 # bd0 <thread_start_threading+0x5a>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	abea0a13          	addi	s4,s4,-1346 # bd0 <thread_start_threading+0x5a>
        if (i == 110) {
...
int main(int argc, char **argv)
{
 ...
 16e:	a0c080e7          	jalr	-1524(ra) # b76 <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a6e50513          	addi	a0,a0,-1426 # be0 <thread_start_threading+0x6a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e2:	71a50513          	addi	a0,a0,1818 # bf8 <digits>
 4e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ae:	64eb8b93          	addi	s7,s7,1614 # bf8 <digits>
 ...
 6ee:	50690913          	addi	s2,s2,1286 # bf0 <thread_start_threading+0x7a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b6:	45e7b783          	ld	a5,1118(a5) # c10 <freep>
 ...
 7e4:	00e6ea63          	bltu	a3,a4,7f8 <free+0x50>
{
 ...
 826:	3ef73723          	sd	a5,1006(a4) # c10 <freep>
}
 82a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 858:	3bc53503          	ld	a0,956(a0) # c10 <freep>
 ...
 880:	39490913          	addi	s2,s2,916 # c10 <freep>
  if(p == (char*)-1)
 884:	5afd                	li	s5,-1
 886:	a88d                	j	8f8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 888:	00000797          	auipc	a5,0x0
 88c:	39878793          	addi	a5,a5,920 # c20 <base>
 890:	00000717          	auipc	a4,0x0
 894:	38f73023          	sd	a5,896(a4) # c10 <freep>
 898:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ba:	34a73d23          	sd	a0,858(a4) # c10 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 9c4:	24c70713          	addi	a4,a4,588 # c0c <id>
 9c8:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 9f8:	2247b783          	ld	a5,548(a5) # c18 <current_thread>
 ...
 a00:	ed58                	sd	a4,152(a0)
	t->next = current_thread;
 a02:	f15c                	sd	a5,160(a0)
        current_thread->previous->next = t;
 a04:	6fd8                	ld	a4,152(a5)
 a06:	f348                	sd	a0,160(a4)
	current_thread->previous = t;
 ...
 a14:	20a7b423          	sd	a0,520(a5) # c18 <current_thread>
	    current_thread->next = t;
 a18:	f148                	sd	a0,160(a0)
	    current_thread->previous = t;
 a1a:	ed48                	sd	a0,152(a0)
...
void schedule(void){
 ...
 a28:	1f478793          	addi	a5,a5,500 # c18 <current_thread>
 a2c:	6398                	ld	a4,0(a5)
...
void thread_exit(void){
 ...
 a46:	1d67b783          	ld	a5,470(a5) # c18 <current_thread>
 a4a:	73d8                	ld	a4,160(a5)
 a4c:	04e78063          	beq	a5,a4,a8c <thread_exit+0x54>
        current_thread->next->previous = current_thread->previous;
 a50:	6fd4                	ld	a3,152(a5)
 a52:	ef54                	sd	a3,152(a4)
	current_thread->previous->next = current_thread->next;
 a54:	73d8                	ld	a4,160(a5)
 a56:	f2d8                	sd	a4,160(a3)
	free(current_thread->stack);
 a58:	6b88                	ld	a0,16(a5)
 a5a:	00000097          	auipc	ra,0x0
 a5e:	d4e080e7          	jalr	-690(ra) # 7a8 <free>
	free(current_thread);
 a62:	00000497          	auipc	s1,0x0
 a66:	1b648493          	addi	s1,s1,438 # c18 <current_thread>
 a6a:	6088                	ld	a0,0(s1)
 a6c:	00000097          	auipc	ra,0x0
 a70:	d3c080e7          	jalr	-708(ra) # 7a8 <free>
	current_thread = current_thread->next;
 a74:	609c                	ld	a5,0(s1)
 a76:	73dc                	ld	a5,160(a5)
 a78:	e09c                	sd	a5,0(s1)
	dispatch();
 a7a:	00000097          	auipc	ra,0x0
 a7e:	046080e7          	jalr	70(ra) # ac0 <dispatch>
	free(current_thread->stack);
	free(current_thread);
    	current_thread = NULL;
	longjmp(env_st, 1);
 ...
 a9a:	18248493          	addi	s1,s1,386 # c18 <current_thread>
 a9e:	6088                	ld	a0,0(s1)
 aa0:	00000097          	auipc	ra,0x0
 aa4:	d08080e7          	jalr	-760(ra) # 7a8 <free>
    	current_thread = NULL;
 aa8:	0004b023          	sd	zero,0(s1)
	longjmp(env_st, 1);
 aac:	4585                	li	a1,1
 aae:	00000517          	auipc	a0,0x0
 ab2:	18250513          	addi	a0,a0,386 # c30 <env_st>
 ab6:	00000097          	auipc	ra,0x0
 aba:	e96080e7          	jalr	-362(ra) # 94c <longjmp>
}
 abe:	b7d1                	j	a82 <thread_exit+0x4a>

0000000000000ac0 <dispatch>:
void dispatch(void){
 ...
 acc:	15053503          	ld	a0,336(a0) # c18 <current_thread>
 ad0:	09452783          	lw	a5,148(a0)
 ad4:	ebb1                	bnez	a5,b28 <dispatch+0x68>
		if(!setjmp(current_thread->env)){
 ad6:	02050513          	addi	a0,a0,32
 ada:	00000097          	auipc	ra,0x0
 ade:	e3a080e7          	jalr	-454(ra) # 914 <setjmp>
 ae2:	c50d                	beqz	a0,b0c <dispatch+0x4c>
		current_thread->buf_set++;
 ae4:	00000797          	auipc	a5,0x0
 ae8:	1347b783          	ld	a5,308(a5) # c18 <current_thread>
 aec:	0947a703          	lw	a4,148(a5)
 af0:	2705                	addiw	a4,a4,1
 af2:	08e7aa23          	sw	a4,148(a5)
 ...
 b00:	f3c080e7          	jalr	-196(ra) # a38 <thread_exit>
}
 b04:	60a2                	ld	ra,8(sp)
 b06:	6402                	ld	s0,0(sp)
 ...
 b10:	10c53503          	ld	a0,268(a0) # c18 <current_thread>
 b14:	6d1c                	ld	a5,24(a0)
 b16:	e55c                	sd	a5,136(a0)
			longjmp(current_thread->env, 1);
 b18:	4585                	li	a1,1
 b1a:	02050513          	addi	a0,a0,32
 b1e:	00000097          	auipc	ra,0x0
 b22:	e2e080e7          	jalr	-466(ra) # 94c <longjmp>
 b26:	bf7d                	j	ae4 <dispatch+0x24>
		current_thread->buf_set++;
 b28:	2785                	addiw	a5,a5,1
 b2a:	08f52a23          	sw	a5,148(a0)
		longjmp(current_thread->env, 1);
 b2e:	4585                	li	a1,1
 b30:	02050513          	addi	a0,a0,32
 b34:	00000097          	auipc	ra,0x0
 b38:	e18080e7          	jalr	-488(ra) # 94c <longjmp>
}
 b3c:	b7e1                	j	b04 <dispatch+0x44>
...
void thread_yield(void){
 ...
 b4a:	0d253503          	ld	a0,210(a0) # c18 <current_thread>
 ...
 b68:	eba080e7          	jalr	-326(ra) # a1e <schedule>
		dispatch();
 b6c:	00000097          	auipc	ra,0x0
 b70:	f54080e7          	jalr	-172(ra) # ac0 <dispatch>
}
 b74:	b7e5                	j	b5c <thread_yield+0x1e>

0000000000000b76 <thread_start_threading>:
void thread_start_threading(void){
 ...
 b82:	ea0080e7          	jalr	-352(ra) # a1e <schedule>
	if(!setjmp(env_st)) dispatch();
 b86:	00000517          	auipc	a0,0x0
 b8a:	0aa50513          	addi	a0,a0,170 # c30 <env_st>
 b8e:	00000097          	auipc	ra,0x0
 b92:	d86080e7          	jalr	-634(ra) # 914 <setjmp>
 b96:	c509                	beqz	a0,ba0 <thread_start_threading+0x2a>
}
 b98:	60a2                	ld	ra,8(sp)
 b9a:	6402                	ld	s0,0(sp)
 ...
 ba4:	f20080e7          	jalr	-224(ra) # ac0 <dispatch>
}
 ba8:	bfc5                	j	b98 <thread_start_threading+0x22>
